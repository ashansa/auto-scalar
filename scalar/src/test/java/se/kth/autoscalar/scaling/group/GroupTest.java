...
public class GroupTest {
    ...
    private int coolingTimeUp = 60;
    private int coolingTimeDown = 300;

    @BeforeClass
    public static void init() throws DBConnectionFailureException {
    ...
    public void testCRUDGroup() throws ElasticScalarException {
        ...
        try {
            groupManager.createGroup( groupName, (int)(random * 10),
                    (int)(random * 100), coolingTimeUp, coolingTimeDown, new String[]{"wrongRule"});
        ...
        Group group = groupManager.createGroup(groupName, (int)(random * 10),
                (int)(random * 100), coolingTimeUp, coolingTimeDown, new String[]{rule.getRuleName()});
        ...
        groupToUpdate.setCoolingTimeUp(coolingTimeUp + 10);
